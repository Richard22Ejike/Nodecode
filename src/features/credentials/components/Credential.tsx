...
import { useCreateCredential, useSuspenseCredential, useUpdateCredential } from "../hooks/use-credential"
...
const formSchema = z.object({
    ...
    type: z.enum([CredentialType.GEMINI, CredentialType.TELEGRAM, CredentialType.OPENAI]),
...
export const CredentialView = ({credentialId}: {credentialId: string}) => {
    ...
    return <CredentialForm initialData={credentialData} />
}